        ...
        <div className="flex-container">
            ...
            <div className="main-content">
                <div className="aboutDescription">
                    ...
                    <p>
                    <ul>
                        <li>Real-Time Stock Data: Stay updated with live stock prices, charts, and market trends. Our real-time data ensures you never miss a market movement.</li>
                        <li>Customizable Watchlists: Create and manage multiple watchlists to track your favorite stocks, ETFs, and indices. Personalize your watchlists with custom alerts and notifications.</li>
                        <li>In-Depth Analysis: Access comprehensive financial data, including historical performance, earnings reports, and key metrics. Utilize our advanced charting tools to analyze stock trends and patterns.</li>
